...
export const nasaQueryKeys = {
  ...
  historicMarsWeather: (params?: Record<string, any>) => ['nasa', 'historic-mars-weather', params] as const,
}
...
export const useHistoricMarsWeather = (
  ...
  return useQuery({
    queryKey: nasaQueryKeys.historicMarsWeather(params),
    queryFn: () => nasaApi.getHistoricMarsWeather(params),
